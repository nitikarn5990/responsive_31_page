                    ...
                    <div class="row ">
                        <div class="bg3-xs padding-top-3em-xs padding-bottom-3em-xs col-xs-12">
                            ...
                            <div class="bg3-body-sentance-1 text-center-xs">
                                <div style="font-family: Arial;font-size: 12px;color: #000;" class="line-height-xs-28">
                        ...
                        <div class="col-xs-12 padding-top-3em-xs padding-bottom-3em-xs">
                            <div class="bg4-body-sentance-1">
                                <div style="font-family:Century Gothic;font-size: 18px;color: #000;text-align: center;">
                                    <strong>  
                                        Independent testing by a French research center <br c class="hidden-sm hidden-xs">
                            ...
                            <div class="bg4-body-sentance-2">
                                ...
                                <div style="font-family:Myriad Pro;font-size: 20px;color: #FFF;text-align: center;">
                                    <div class="color-red-xs font-bold-xs">
                                        90%
                                    </div>
                                </div>
                                <div style="margin-bottom: 30px;" class="hidden-sm hidden-xs"></div>
                            ...
                            <div class="bg4-body-sentance-10">
                                ...
                                <div style="font-family:Arial;font-size: 14px;color: #000;">
                                    <div class="text-indent-xs">The unique revitalizing formulation of Filorga's NCTF 135 is associated with <br class="hidden-sm hidden-xs">
                                        a number of factors that promote wrinkle repair and anti-aging benefits.<br><br>
                                    </div>
                    ...
                    <div class="row">
                        <div class="bg4-xs padding-top-2em-xs padding-bottom-5em-xs col-xs-12">
                            ...
                            <div class="bg5-body-sentance-2 text-indent-xs">
                                ...
                                <div style="font-family:  Arial; font-size: 14px;color: #000;">
                                    Mesotherapy is a biological and progressive treatment that requires <br class="hidden-sm hidden-xs">
                                    a minimum of 6 sessions (3 months) in order for a skin to be maximally.
                                </div>
                            </div>
                            <p class="hidden-lg hidden-md">&nbsp;</p>
                            ...
                            <div class="bg5-body-sentance-4">
                                <div style="font-family:  Arial; font-size: 14px;color: #000;" class="text-indent-xs">
                                    Determine suitable treatment intervals according to the indications of each patient. <br>
                            ...
                            <div class="bg5-body-sentance-5">
                                <div style="font-family:   Century Gothic; font-size: 18px;color: #000;">
                                    <strong> Duration of the treatment</strong><br>
                                </div>
                                <div style="font-family:  Arial; font-size: 14px;color: #000;" class="text-indent-xs">

                                    typically a treatment lasts between 15 minutes and 30 minutes <br class="hidden-sm hidden-xs">
