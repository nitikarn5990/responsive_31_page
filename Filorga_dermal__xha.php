                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="bg1-head-sentance-1 font-bold-xs text-center-xs" style="">
                                ...
                                <div class="bg1-head-sentance-10">
                                    <span style="font-family: Arial;font-size: 12px;color: #0e0e0e;" class="">
                                        Disclaimer: Results may vary between individuals.
                                    </span>    
                                </div>
                                <div class="bg1-head-sentance-11">
                                    <span style="font-family: Century Gothic;font-size: 24px;color: #0e0e0e;" class="">
                                        Filorga X-HA Volume is a new, highly effective <br class="hidden-sm hidden-xs">
                        ...
                        <div class="col-xs-12">
                            <div class=" border-xs">
                                <div class="bg5-body-sentance-1 text-center-xs">
                                    ...
                                    <span style="font-family:  Century Gothic; font-size: 24px;color: #000;">
                                        M-HA 18 is formulated with <br>
                                        18mg/ml of highly cross-linked <br>
                                        hyaluronic acid.
