...
<html>
    ...
    <body>
        ...
        <style>
            .bg1-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg1-xs.jpg) center top no-repeat ;
            ...
            .bg2-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg2-xs.jpg) center top no-repeat ;
                -moz-background-size: cover;
                background-size: cover;
                background-position: 100% 100%;
            }
            .bg3-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg3-xs.jpg) center top no-repeat ;
                -moz-background-size: cover;
                background-size: cover;
            ...
            .bg4-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg4-xs.jpg) center top no-repeat ;
                -moz-background-size: cover;
                background-size: cover;
                background-position: 64% 100%;
            }
            .bg5-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg5-xs.jpg) center top no-repeat ;
                -moz-background-size: cover;
                background-size: cover;
            ...
            .bg6-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg6-xs.jpg) center top no-repeat ;
                -moz-background-size: cover;
                background-size: cover;
            ...
            .bg6-2-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg6-2-xs.jpg) center top no-repeat ;
                -moz-background-size: cover;
                background-size: cover;
            ...
            .bg6-3-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg6-3-xs.jpg) center top no-repeat ;
                -moz-background-size: cover;
                background-size: cover;
                background-position: 50% 100%;
            }
            .bg7-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg7-1-xs.jpg) center top no-repeat ;
                -moz-background-size: cover;
                background-size: cover;
                background-position: 50% 100%;
            }
            .bg8-xs{
                width: 100%;
                background: #FFF url(images/Filorga_dermal__xha/bg8-xs.jpg) center top no-repeat ;
                -moz-background-size: cover;
                background-size: cover;
                background-position: 50% 100%;
            }
            ...
            @media(min-width:992px){
                ...
                .bg5{
                    background-image: url(images/Filorga_dermal__xha/bg5.jpg);
                    background-repeat: no-repeat;
                    width: 800px;
                    height: 1032px;
                }
