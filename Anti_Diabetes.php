                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bg2-head-sentance-1">
                                <span style="font-family: Century Schoolbook; font-size: 42px;color: #000;">
                                    <span class="font-xs-28 font-bold-xs">  Filorga A-Series Rage : <br>
                                        Anti Gout
                                    </span>
                                </span>
                                <br>
                                ...
                                <div style="font-family: Arial; font-size: 12px;color: #000;line-height: 19px;text-align: left;" class="bg2-head-sentance-3"> 
                                    ...
                                    microporous membrane that removed all bacteria.<br class="hidden-sm hidden-xs"><br class="hidden-sm hidden-xs">

                                    Filorga A-Series provides you one easy to take vial for seven of the most common and frequent conditions and ailments we <br class="hidden-sm hidden-xs">
                                    encounter as we get older.
                ...
                <div class="bg3">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="bg3-body-sentance-1  text-indent-xs text-center">
                        ...
                        <div class="col-xs-12">
                            <div class="bg3-body-sentance-18">
                                <div style="font-family: Century Gothic;font-size: 24px; text-align: right;"> 
                                    <div class="text-left-xs">  Female <br>
                                        Regeneration
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12">
                            <div class="bg3-body-sentance-24">
                                <div style="font-family: Arial;font-size: 12px;color: red;"> 

                                    (If you would still like more information about one of the Filorga A-Series products or a brochure to look over in the privacy of your <br>
