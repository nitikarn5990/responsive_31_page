...
<html>
        ...
        <div class="container">
                                    ...
                                    <p style="line-height: 25px;" class="">
                                        <span style="font-family: Century Gothic;font-size: 16px;">
                                            ...
                                            <span style="font-family: times new roman;font-size: 28px;">  
                                                <span class="font-xs-18 font-bold-xs text-shadow-low"><i>Reverse</i></span> 
                                            </span>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-xs-12">
                            <div class="bg3-head-sentance-1 line-height-xs-28 text-center-xs">
                                <span style="font-family: times new roman;font-size: 34px;color: #000;">
                        ...
                        <div class="bg3-xs padding-top-2em-xs padding-bottom-2em-xs col-xs-12">
                            ...
                            <div class="col-xs-12">
                                <div class="bg3-body-sentance-4">
                                    <div style="font-family: Arial;font-size: 12px;" class="text-indent-xs line-height-xs-20"> 
                        ...
                        <div class="col-xs-12">
                            ...
                            <p class="hidden-lg hidden-md"><img src="images/Filorga_a_series/Anti_Diabetes/img1.jpg" class="img-responsive margin-auto"></p>
                        </div>
                        <p class="hidden-lg hidden-md">&nbsp;</p>
                        <div class="bg4-xs col-xs-12 bg_color_2-xss ">
                            <p class="hidden-lg hidden-md">&nbsp;</p>
            ...
            <div class="bg6">
                <div class="row">
                    ...
                    <div class="bg6-2-xs padding-bottom-2em-xs padding-top-2em-xs col-xs-12 box-shadow-xs box-shadow-xs">
                        <p>&nbsp;</p>
                    ...
                    <div class="padding-bottom-2em-xs padding-top-1em-xs col-xs-12">
                ...
                <div class="row">
                    <div class="bg7-xs padding-bottom-4em-xs padding-top-1em-xs col-xs-12">
                        ...
                        <p class="hidden-md hidden-lg">
                            <img src="images/Filorga_a_series/Anti_Diabetes/bg7-img1-xs.png" class="img-responsive margin-auto">
                        </p>
    ...
    <style>
        ...
        .bg1-xs{
            width: 100%;
            background: #FFF url(images/Filorga_a_series/Anti_Diabetes/bg1-xs.jpg) center top no-repeat ;
        ...
        .bg2-xs{
            width: 100%;
            background: #FFF url(images/Filorga_a_series/Anti_Diabetes/bg2-xs.jpg) center top no-repeat ;
            -moz-background-size: cover;
            background-size: cover;
        ...
        .bg3-xs{
            width: 100%;
            background: #FFF url(images/Filorga_a_series/Anti_Diabetes/bg3-xs.jpg) center top no-repeat ;
            -moz-background-size: cover;
            background-size: cover;
        ...
        .bg4-xs{
            width: 100%;
            background: #FFF url(images/Filorga_a_series/Anti_Diabetes/bg4-xs.jpg) center top no-repeat ;
            -moz-background-size: cover;
            background-size: cover;
            background-position: 64% 100%;
        }
        ...
        .bg6-1-xs{
            width: 100%;
            background: #FFF url(images/Filorga_a_series/Anti_Diabetes/bg6-1-xs.jpg) center top no-repeat ;
            -moz-background-size: cover;
            background-size: cover;
            background-position: 50% 100%;
        }
        .bg6-2-xs{
            width: 100%;
            background: #FFF url(images/Filorga_a_series/Anti_Diabetes/bg6-2-xs.jpg) center top no-repeat ;
            -moz-background-size: cover;
            background-size: cover;
        ...
        .bg6-3-xs{
            width: 100%;
            background: #FFF url(images/Filorga_a_series/Anti_Diabetes/bg6-3-xs.jpg) center top no-repeat ;
            -moz-background-size: cover;
            background-size: cover;
            background-position: 50% 100%;
        }
        .bg7-xs{
            width: 100%;
            background: #FFF url(images/Filorga_a_series/Anti_Diabetes/bg7-1-xs.jpg) center top no-repeat ;
            -moz-background-size: cover;
            background-size: cover;
            background-position: 50% 100%;
        }
        .bg8-xs{
            width: 100%;
            background: #FFF url(images/Filorga_a_series/Anti_Diabetes/bg8-xs.jpg) center top no-repeat ;
            -moz-background-size: cover;
            background-size: cover;
            background-position: 50% 100%;
        }
